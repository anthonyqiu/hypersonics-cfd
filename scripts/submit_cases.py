...
from case_selection import add_managed_case_filter_args, filter_case_specs
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Dry-run or submit managed CFD cases using the shared SLURM template."
    )
    parser.add_argument(
        "--campaign",
        default="orion",
...
def select_cases(args: argparse.Namespace, case_specs: list[dict[str, object]]) -> list[dict[str, object]]:
    explicit_filters = bool(args.cases or args.experiment or args.mach or args.aoa or args.mesh_level)
...
def main() -> int:
    ...
    try:
        case_specs = select_cases(args, all_case_specs)
