...
def process_case(case_dir: str, grid_bins: int, dx_override: float | None, dyz_override: float | None):
    ...
    aoa_degrees = load_case_aoa_degrees(ROOT, case_path)
...
def main() -> int:
    ...
    for case in cases:
        print(f"-> {case}")
        process_case(case, args.grid_bins, dx_override, dyz_override)
